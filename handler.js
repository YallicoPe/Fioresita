...
text = (action === 'add' ? (chat.sWelcome || this.welcome || conn.welcome || 'Welcome, @user!').replace('@subject', await this.getName(id)).replace('@desc', groupMetadata.desc?.toString() || '𝗙𝗶𝗼𝗿𝗲 𝗕𝗼𝘁 🎀') :
...
"thumbnail": apii.data, 
"title": [wm, '' + gt + '🎀', 'https://chat.whatsapp.com/LHo0RmYd3pxAQzp24NYcTV'].getRandom(),
...
let prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: msg, contextInfo: { externalAdReply: { title: lenguajeGB.smsAvisoAG().slice(0,-2), body: [wm, '' + gt + '🎀', 'https://chat.whatsapp.com/LHo0RmYd3pxAQzp24NYcTV'].getRandom(), thumbnail: gataImg, sourceUrl: accountsgb }}}}, tg)
